	...
	for(i = 0; i < jData.length; i++) {
		...
		tntRCjTable.append(
			"<tr>"+
				...
				"<td class='tntRCrelaisColis' width='75%'>" + nomRelais + " - " + adresse + " - " + codePostal + " - " + commune + "<BR>&nbsp;&nbsp;&nbsp;&nbsp;>> Ouvert jusqu'&agrave; " + heureFermeture + "</td>"+
...
function tntRCenteteGrise6Col2() {
	return("<tr height='25px'><td class='tntRCgris' colspan='2' width='70%'>&nbsp;Les diff&eacute;rents Relais Colis&#174;</td><td class='tntRCgris' width='30%' align='center'>&nbsp;Mon choix</td></tr>");
};
